...
<!--TODO:-->Just wanted to revise from `\` to `<leader>E` or `<leader>E` for the sidebar toggle. Because nvim-lazyvim has this shortcut built-in as default and it's quite convenient after sometime of using it. 
