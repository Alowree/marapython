...
Always read the official guide in the first place when you are learning to use a new tool.

Default keymaps from lazyvim
...
Following content list out the whereabouts of the config.
