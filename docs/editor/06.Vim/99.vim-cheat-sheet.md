...
| `<C-q>` | Enter block-wise **VISUAL** mode                                 |
...
- `:s%/old/new` search and replace the first occurence
- `:s%/old/new/g` search and replace all occurences, without confirmation
- `:s%/old/new/gc` search and replace all occurences, one by one confirmation
- `:s%/old/new/gi` search and replace all occurences, ignoring case
